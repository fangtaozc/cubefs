...
func parseMountOption(cfg *config.Config) (*proto.MountOptions, error) {
	...
	opt.OssAccelMoverAddr = GlobalMountOptions[proto.OssAccelMoverAddr].GetString()
	opt.OssAccelAdminToken = GlobalMountOptions[proto.OssAccelAdminToken].GetString()
